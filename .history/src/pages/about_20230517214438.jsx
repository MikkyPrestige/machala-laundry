...
const About = () => {
  return (
    <section className="wrapper overflow">
      <Helmet>
        ...
        <Zoom cascade damping={0.5}>
          ...
          <div className="about--content">
            <p className="about--content__text">
              We are a full service Laundry provider headquartered in Asaba,
              Delta State. Machala Laundry is the place for your Washing,
              Ironing and Folding of laundries. We render Modern, fast and
              friendly services. At Machala Laundry we take pride in having the
              knowledge, skills, expert resources and the products required to
              make your Laundry operations excellent.
            </p>
        ...
        <Fade direction="down" cascade damping={1}>
          ...
          <div className="services--content">
            ...
            <div className="services--content__item">
              ...
              <h2 className="services--content__item--title">
                Delivery Service
              </h2>
            </div>
          </div>
