  ...
  return (
    <section className="stores">
      <div className="stores--headOffice">
       ...
       <h1 className="stores--headOffice__title">Stores</h1>
        <h2 className="stores--headOffice__title">Come Visit Us</h2>
       </header>
        <div className="stores--headOffice__body">
          ...
          <div className="stores--headOffice__body--content">
            <div className="stores--headOffice__body--content__item">
              ...
              <div className="stores--headOffice__body--content__item--text">
                <h3 className="stores--headOffice__body--content__item--text__">
    </section>
  );
}