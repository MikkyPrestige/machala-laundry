...
const About = () => {
  return (
    <section className="wrapper">
      <Helmet>
        <title>Machala Laundry | About</title>
        <meta
          name="description"
          content="Machala Laundry is the place for your washing, ironing, and folding of laundries. We render modern, fast, and friendly service"
        />
      </Helmet>
      <Layout />
