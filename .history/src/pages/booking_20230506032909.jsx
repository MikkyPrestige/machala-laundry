        ...
        <div className="booking--container__body">
          <form className="booking--container__body--form">
            ...
            <div className="booking--container__body--form__instruction">
             <div>
             <h3 className="booking--container__body--form__instruction--title">
                Important Instructions
              </h3>
              <p className="booking--container__body--form__instruction--text">
              ...
              <label>
                <input
                  ...
                  name="instruction"
                  id="instruction"
                  className="booking--container__body--form__instruction--checkbox"
                />
                <span className="booking--container__body--form__instruction--text">
              ...
              <label>
                ...
                />
                <span className="booking--container__body--form__instruction--text">
                 Any lost item must be reported via email to within 5 business days.
                </span>
              </label>
              <label>
                <input
                ...
                />
                <span className="booking--container__body--form__instruction--text">
                 We request that customers remove items and empty pockets prior to leaving their laundry with us as we cannot be held responsible for damage of your garments from the left items in pockets.
                </span>
              </label>
              <textarea
              className="booking--container__body--form__instruction--textarea"
