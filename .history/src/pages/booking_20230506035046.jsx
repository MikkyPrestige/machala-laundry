    ...
    <section className="wrapper">
      ...
      <div className="booking">
        <header className="booking--header">
          <div className="booking--header--head">
            <h1 className="booking--header--head__title">
          ...
          <p className="booking--header--head__subtitle">
            Fill the form below to book a service with us
          </p>
        </header>
        <div className="booking--body">
          <form className="booking--body--form">
            <div className="booking--body--form__group">
              <label
                htmlFor="full-name"
                className="booking--body--form__group--label"
              >
                Full Name
              </label>
              <input
                ...
                name="full-name"
                id="full-name"
                className="booking--body--form__group--input"
            ...
            <div className="booking--body--form__instruction">
              <div className="booking--body--form__instruction--header">
                <h3 className="booking--body--form__instruction--header__title">
                  Important Instructions
                </h3>
                <p className="booking--body--form__instruction--header__subtitle">
              ...
              <div className="booking--container--form__instruction--group">
                <label
                  htmlFor="lost"
                  className="booking--container--form__instruction--group__label"
                >
                  <input
                    type="checkbox"
                    name="lost"
                    id="lost"
                    className="booking--container--form__instruction--group__label__checkbox"
                  />
                  <span className="booking--container--form__instruction--group__label__text">
              ...
              <textarea className="booking--body--form__instruction--textarea">
