        ...
        <div className="booking--container__body">
          <form className="booking--container__body--form">
            ...
            <div className="booking--container__body--form__instruction">
              ...
              <label htmlFor="lost" className="booking--container__body--form__instruction--label">
                <input
                  type="checkbox"
                  name="lost"
                  id="lost"
              ...
              <label htmlFor="caution" className="booking--container__body--form__instruction--label">
                <input
                  type="checkbox"
                  name="caution"
                  id="caution"
