          ...
          <form className="booking--container__body--form">
            ...
            <div className="booking--container__body--form__instruction">
              ...
              <label>
                ...
                />
                <span className="booking--container__body--form__instruction--text">
                  Any lost item must be reported via email to within 5 business
                  days.
                </span>
              </label>
              <label>
                ...
                />
                <span className="booking--container__body--form__instruction--text">
                  We request that customers remove items and empty pockets prior
                  to leaving their laundry with us as we cannot be held
                  responsible for damage of your garments from the left items in
                  pockets.
                </span>
              </label>
              <textarea
