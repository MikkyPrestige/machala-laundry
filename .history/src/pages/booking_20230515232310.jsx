...
const Booking = () => {
  ...
  const validateForm = () => {
    ...
    if (!form.pickupAddress.trim()) {
      isValid = false;
      errors["pickupAddress"] = "Please enter your pickup address";
    }

    if (!form.deliveryAddress.trim()) {
      isValid = false;
      errors["deliveryAddress"] = "Please enter your delivery address";
    }

    if (!form.pickupDateTime.trim()) {
      isValid = false;
      errors["pickupDateTime"] = "Please enter your pickup date and time";
    }

    if (!form.deliveryDateTime.trim()) {
      isValid = false;
      errors["deliveryDateTime"] = "Please enter your delivery date and time";
    }
