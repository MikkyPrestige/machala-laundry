...
const Booking = () => {
  const [form, setForm] = useState(() => {
    // Retrieve form inputs from local storage on component mount or initialize with empty values
  ...
  useEffect(() => {
    // Save form inputs to local storage whenever the form state changes
    ...
    if (!form.name.trim()) {
      ...
      if (
          ...
          if (isNaN(pickupDate) || pickupDate < new Date()) {
            isValid = false;
            errors["pickupDateTime"] = "Please enter a pickup date and time that is at least 24 hours from now";
          }
        }
      ) {
        isValid = false;
        errors["pickupDateTime"] =
          "Please enter a pickup date and time that is at least 24 hours from now";
      }
  ...
  return (
    ...
    >
      ...
      <header className="booking--header">
        <h1 className="booking--header__title">Laundry service request form</h1>
      ...
      <div className="booking--container">
        ...
        {success && (
          <div className="booking--popup">
            <div className="booking--popup__avatar">
              <Avatar
                image={HandShake}
                alt="Hand Shake"
            ...
            <h2 className="booking--popup__title">
              Thanks for your patronage <strong>{successName}</strong>!
            </h2>
