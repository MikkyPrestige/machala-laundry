        ...
        <div className="booking--container">
          ...
          {success && (
            <div className="booking--container__popup">
              <h2 className="booking--container__popup--title">
                Thank you <strong>{successName}</strong>!
              </h2>
              <p className="booking--container__popup--text">
                Your request has been received. We will get back to you as soon
                as possible.
              </p>
              <button
                className="booking--container__popup--btn"
                onClick={removePopup}
              >
                Close
              </button>
          ...
          <form className="booking--container--form" onSubmit={submitForm}>
            <div className="booking--container--form__group">
              ...
              />
              {/* {error.name && ( */}
              <p className="booking__container--form__error">{error.name}</p>
              {/* )} */}
            </div>
            <div className="booking--container--form__group">
              <label
