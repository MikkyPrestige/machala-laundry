    ...
    <section className="wrapper">
      ...
      <div className="booking">
        ...
        <div className="booking--container">
          ...
          {success && (
            <div className="booking--container__popup">
              <div className="booking--container__popup--content">
                <h2 className="booking--container__popup--content__title">
                  Thank you {successName}!
                </h2>
                <p className="booking--container__popup--content__text">
                  Your request has been received. We will get back to you as
                  soon as possible.
                </p>
                <button
                  className="booking--container__popup--content__btn"
                  onClick={removePopup}
                >
                  Close
                </button>
