        ...
        <div className="booking--container">
          ...
          <form className="booking--container--form" onSubmit={submitForm}>
            <div className="booking--container--form__group">
              ...
              />
               {error.fullName && (
              <p className="booking__container--form__error">{error.fullName}</p>
            )}
            </div>
            <div className="booking--container--form__group">
              <label
            ...
            <div className="booking--container--form__group">
              ...
              />
              {error.phoneNumber && (
              <p className="booking__container--form__error">{error.phoneNumber}</p>
            )}
            </div>
            <div className="booking--container--form__group">
              <label
            ...
            <div className="booking--container--form__group">
              ...
              {error.serviceType && (
              <p className="booking__container--form__error">{error.serviceType}</p>
            )}
            </div>
