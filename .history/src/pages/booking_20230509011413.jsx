        ...
        <div className="booking--container">
          ...
          <form className="booking--container--form">
            ...
            <div className="booking--container--form__check">
              ...
              <label className="booking--container__body--form__check--content__label">
                <input
                  type="checkbox"
                  name="instruction"
                  id="instruction"
                  className="booking--container__body--form__check--content__label__checkbox"
                />
                <span className="booking--container__body--form__check--content__label__text">
