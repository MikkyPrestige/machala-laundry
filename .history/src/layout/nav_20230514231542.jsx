...
const LayoutLarge = () => {
  return (
    <div className="layoutLarge">
      <nav className="layoutLarge--nav">
        <ul className="layoutLarge--nav__lists">
          <li>
            <CustomNavLink to="/" className="layoutLarge--nav__lists__item">
              <RiHomeHeartFill className="layoutLarge--nav__lists__item--icon" />
              <span>Home</span>
            </CustomNavLink>
          </li>
          <li>
            <CustomNavLink
              to="/about"
              className="layoutLarge--nav__lists__item"
            >
              <FcAbout className="layoutLarge--nav__lists__item--icon" />
              <span>About Us</span>
            </CustomNavLink>
          </li>
          <li>
            <CustomNavLink
              ...
              className="layoutLarge--nav__lists__item"
            >
              <MdOutlineLocalLaundryService className="layoutLarge--nav__lists__item--icon" />
              <span>Locations</span>
            </CustomNavLink>
          </li>
          <li>
            <CustomNavLink
              ...
              className="layoutLarge--nav__lists__item"
            >
              <MdContactPhone className="layoutLarge--nav__lists__item--icon" />
              <span>Book Us</span>
            </CustomNavLink>
          </li>
        </ul>
