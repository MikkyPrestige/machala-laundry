...
import { MdClose, MdOutlineLocalLaundryService, MdContactPhone } from "react-icons/md";
    ...
    <section className="layoutSmall">
      <header className="layoutSmall--header">
        ...
        <div className="layoutSmall--header__nav">
          ...
          >
            {isNavOpen ? <MdClose className="layoutSmall--header__nav__toggle--icon"/> : <FiMenu className="layoutSmall--header__nav__toggle--icon" />}
          </button>
          <nav
