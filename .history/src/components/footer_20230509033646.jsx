      ...
      <section className="footer--container">
        ...
        <section className="footer--social">
          <h3 className="footer--social__title">
            ...
            <SiMaildotru className="footer--social__content--header__title--icon" />
          </h3>
          <div className="footer--social__content">
            <div className="footer--social__content--header">
              <h2 className="footer--social__content--header__title">Our Locations in Asaba, Delta State:</h2>
              <p className="footer--social__content--header__text">
              <GoLocation className="footer--social__content--header__text--icon" />
                <a
