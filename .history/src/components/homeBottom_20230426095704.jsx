      ...
      <section className="work paddingTop-sm">
        ...
        <div className="work--content2">
          <div className="work--content2__progress-bar">
            <span className="work--content2__progress-bar__stop one" style={{left: "33.33%"}}>1</span>
            <span className="work--content2__progress-bar__stop two" style={{left: "66.66%"}}>2</span>
            <span className="work--content2__progress-bar__stop three" style={{right: "0"}}>3</span>
          </div>
