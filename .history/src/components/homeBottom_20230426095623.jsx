      ...
      <section className="work paddingTop-sm">
        ...
        <div className="work--content2">
          <div className="work--content2__progress-bar">
            <span className="work--content2__progress-bar__stop one" style={{left: "33"}}>1</span>
            <span className="work--content2__progress-bar__stop two">2</span>
            <span className="work--content2__progress-bar__stop three">3</span>
          </div>
