    ...
    <footer className="footer">
        ...
        <section className="footer--social">
          ...
          <div className="footer--social__content">
            ...
            <div className="footer--social__content--item">
              <a href="tel: +23409034789024" target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer--social__content--item">
              <a href="https://web.facebook.com/groups/5384168368329844/?ref=share&_rdc=1&_rdr" target="_blank" rel="noopener noreferrer">
