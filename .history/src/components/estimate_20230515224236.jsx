    ...
    <section className="estimate">
      ...
      <table className="estimate--table">
        ...
        <tbody className="estimate--table__body">
          <tr className="estimate--table__body--row">
            ...
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /><span>300</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>200</span></td>
          </tr>
          <tr className="estimate--table__body--row">
            <td className="estimate--table__body--row__item">T-Shirt</td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>300</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>50</span></td>
          </tr>
          <tr className="estimate--table__body--row">
          ...
          <tr className="estimate--table__body--row">
            ...
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>300</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>150</span></td>
          </tr>
          <tr className="estimate--table__body--row">
            <td className="estimate--table__body--row__item">Suit</td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>1000</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>600</span></td>
          </tr>
          <tr className="estimate--table__body--row">
            <td className="estimate--table__body--row__item">Complete Suit</td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>1500</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>700</span></td>
          </tr>
          <tr className="estimate--table__body--row">
          ...
          <tr className="estimate--table__body--row">
            ...
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>500</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>400</span></td>
          </tr>
          <tr className="estimate--table__body--row">
          ...
          <tr className="estimate--table__body--row">
            ...
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>200</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>100</span></td>
          </tr>
          <tr className="estimate--table__body--row">
          ...
          <tr className="estimate--table__body--row">
            ...
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>2000</span></td>
            <td className="estimate--table__body--row__item"><TbCurrencyNaira className="estimate--table__body--row__item--icon" /> <span>500</span></td>
          </tr>
          <tr className="estimate--table__body--row">
      ...
      <div className="estimate--note">
        <div className="estimate--note__avatar">
          <p className="estimate--note__avatar--text">Thanks for your patronage</p>
          <Avatar
            image={HandShake}
            alt="Hand Shake"
