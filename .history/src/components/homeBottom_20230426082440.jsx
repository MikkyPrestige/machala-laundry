      ...
      <section className="work">
        ...
        <div className="work--content">
          <div class="work--content__progress-bar">
            <span class="work--content__progress-bar__stop">1</span>
            <span class="work--content__progress-bar__stop">2</span>
            <span class="work--content__progress-bar__stop">3</span>
          </div>
