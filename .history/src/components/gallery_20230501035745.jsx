...
const Gallery = () => {
  ...
  return (
    <section className="gallery">
      ...
      <div className="gallery--caro">
        <div className="gallery--container__image">
          <Avatar
            src={images[imageIndex]}
            alt="gallery"
            className="gallery--container__image--avatar"
          />
        </div>
        <div className="gallery--container__btn">
          <button className="gallery--container__btn--prev" onClick={prevImage}>
            <FcPrevious />
          </button>
          <button className="gallery--container__btn--next" onClick={nextImage}>
            <FcNext />
          </button>
        </div>
      </div>
