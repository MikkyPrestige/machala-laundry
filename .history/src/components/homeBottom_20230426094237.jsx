      ...
      <section className="work paddingTop-sm">
        ...
        <div className="work--content2">
          <div className="work--content2__progress-bar">
            <span className="work--content2__progress-bar__stop">1</span>
            <span className="work--content2__progress-bar__stop">2</span>
            <span className="work--content2__progress-bar__stop">3</span>
          </div>
          ...
          <div className="work--content2__items__item">
            ...
            <div className="work--content2__items__item--text">
              <h3 className="work--content2__items__item--text__title">We collect</h3>
          ...
          <div className="work--content2__items__item">
            ...
            <div className="work--content2__item2--text">
              <h3 className="work--content2__item2--text__title">We clean</h3>
              <p className="work--content2__item2--text__subtitle">
                We use the best quality products and clean your laundry with utmost care.
              </p>
            </div>
          </div>
          <div className="work--content2__item2">
            <div className="work--content2__item2--avatar">
              <Avatar
                image={deliver}
                alt="Delivery Image"
                style={{ width: "100%", height: "100%" }}
            ...
            <div className="work--content2__item2--text">
              <h3 className="work--content2__item2--text__title">We deliver</h3>
              <p className="work--content2__item2--text__subtitle">
